...
const Intro = () =>{
    ...
    return(
        ...
        {/* Floorplan SVGs */}
        <img src={voicearchi_svg_floorplan_outer_wall} alt="Floorplan SVG" className="animate-book-open-right invert-100 h-50 w-auto absolute left-1/2 transform -translate-x-1/2 top-70" />
        <img src={voicearchi_svg_floorplan_inner_wall} alt="Floorplan SVG" className="animate-book-open-left invert-100 h-50 w-auto absolute left-1/2 transform -translate-x-1/2 top-70" />
